...
contract CreepSigner is EIP712Upgradeable {

    string private constant SIGNING_DOMAIN = "CreepCrewAditus";
    ...
    */
    function _signedDataHash(signedData memory _signedData) internal view returns (bytes32) {
        return
            ...
            keccak256(
                abi.encode(
                    keccak256("signedData(address userAddress,uint256 amount)"),
